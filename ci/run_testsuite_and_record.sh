...
echo "test" | coverage run --rcfile ../pyproject.toml -m mreg_cli -u test -d example.org --url http://127.0.0.1:8000 --source testsuite --record new_testsuite_log.json --record-without-timestamps -v ERROR >/dev/null
